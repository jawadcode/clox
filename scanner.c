...
// Compare identifier with keyword after first letter
...
static TokenType identifierType() {
  // Use trie to check if the lexeme is a keyword or identifier
...
static Token string() {
  ...
  while (peek() != '"' && !isAtEnd()) {
    // Manually increment line number because skipWhitespace() isn't being
    // called
    if (peek() == '\n')
      scanner.line++;
    advance();
